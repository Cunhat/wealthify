...
export type WishlistCategoryForm = z.infer<typeof WishlistCategorySchema>;

type WishlistCategoryFormProps = {
	form: UseFormReturn<WishlistCategoryForm>;
	onSubmit: (values: WishlistCategoryForm) => void;
	disabled: boolean;
	formId: string;
};

export default function WishlistCategoryForm({
	form,
	onSubmit,
	disabled,
	formId,
